...
class _BankDetailsWidgetState extends State<BankDetailsWidget> {
  ...
  void initState() {
    ...
    _model.dematAccountIDTextController ??= TextEditingController();
    _model.dematAccountIDFocusNode ??= FocusNode();
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 35.0, 0.0, 10.0),
                              child: TextFormField(
                                controller: _model.dematAccountIDTextController,
                                focusNode: _model.dematAccountIDFocusNode,
                                autofocus: false,
                                obscureText: false,
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 15.0, 0.0, 40.0),
                              child: Text(
                                'Automatically selected for this demat account',
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                                      fontFamily: 'Readex Pro',
